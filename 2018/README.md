...
此專案為 2018 年台灣大學校院積體電路設計競賽 (IC Design Contest) 大學部 B 組初賽題目的 RTL 實作與時序優化紀錄。本設計成功通過 Pre-sim 與 Post-sim 驗證，並針對時鐘週期`(<10ns)`進行了時序優化。
...
| **Clock Period** | 7.1 ns | 無時序違規 (Slack = 0.00) |
